...
public class GitHubExerciseContentClientTest {
    ...
    void shouldFetchAndDecodePinnedExerciseDefinition() {
        ...
        GitHubExerciseContentClient client = new GitHubExerciseContentClient(
                restClientBuilder,
        ...
        ExerciseContentDefinition definition =
                client.getExerciseContent("java-variables-001");
        ...
        assertThat(definition.execution().tests())
                .singleElement()
                .satisfies(testCase ->
                        assertThat(testCase.expectedStdout()).isEqualTo("25\n")
                );
    ...
    private String githubFileResponse() {
        ...
        String encodedContent = Base64.getEncoder().encodeToString(
                exerciseJson.getBytes(StandardCharsets.UTF_8)
        );
